...
1. Assign a variable called `is_delicious` to a boolean value
1. Re-assign your `food` variable to a new string
1. Assign a variable called `num_2` to a numerical value
1. Assign a variable called `num_7` to a different numerical value
1. Divide your `num_7` variable by your  `num_2` variable and store the result in a new variable called `quotient`
